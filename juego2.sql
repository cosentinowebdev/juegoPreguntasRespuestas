...
--
-- Servidor: localhost
-- Tiempo de generación: 10-07-2023 a las 21:58:36
...
(2, '¿Cuál de los siguientes no es un lenguaje de programación?', 'HTML', 'Java', 'Python', 'C++', 6, 1, 1, 1, 'Easy'),
(3, '¿Qué significa CSS?', 'Cascading Style Sheets', 'Common Style Sheets', 'Creative Style Sheets', 'Computer Style Sheets', 7, 1, 1, 1, 'Easy'),
(4, '¿Cuál es el símbolo utilizado para denotar una clase en CSS?', '.', '#', '@', '$', 4, 1, 1, 1, 'Easy'),
(5, '¿Cuál de los siguientes es un lenguaje de programación orientado a objetos?', 'Java', 'SQL', 'HTML', 'CSS', 59, 0, 1, 1, 'Easy'),
(6, '¿Cuál es el resultado de sumar 2 y 3 en el lenguaje de programación JavaScript?', '5', '2', '3', '23', 3, 1, 1, 1, 'Easy'),
(7, '¿Qué es un bucle \"for\" en programación?', 'Una estructura de control', 'Un tipo de dato', 'Una función', 'Un operador', 5, 1, 1, 1, 'Easy'),
(8, '¿Cuál de los siguientes no es un tipo de dato en JavaScript?', 'Float', 'String', 'Boolean', 'Number', 1, 0, 1, 1, 'Easy'),
...
(10, '¿Cuál es el resultado de la operación lógica AND entre true y false?', 'false', 'true', 'null', 'undefined', 0, 0, 1, 1, 'Easy'),
(11, '¿Cuál es el resultado de 5 modulo 2?', '1', '2', '0', '5', 0, 5, 1, 1, 'Easy'),
(12, '¿Cuál de los siguientes no es un framework de desarrollo web?', 'Photoshop', '', 'Angular', 'Vue', 3, 1, 1, 1, 'Easy'),
(13, '¿Cuál de los siguientes no es un tipo de dato primitivo en Java?', 'String', 'int', 'boolean', 'double', 0, 1, 1, 1, 'Easy'),
(14, '¿Qué significa SQL?', 'Structured Query Language', 'Simple Query Language', 'System Query Language', 'Structured Query Logic', 0, 2, 1, 1, 'Easy'),
(15, '¿Cuál es el resultado de la operación 4 + \"4\" en JavaScript?', '\"44\"', '8', 'NaN', '\"8\"', 0, 2, 1, 1, 'Easy'),
(16, '¿Cuál de los siguientes es un sistema operativo de código abierto?', 'Linux', 'Windows', 'MacOS', 'iOS', 1, 0, 1, 1, 'Easy'),
(17, '¿Qué es un repositorio en el contexto de Git?', 'Un lugar donde se almacenan los archivos de un proyecto', 'Una función que permite realizar cálculos', 'Una estructura de control', 'Una biblioteca de funciones', 1, 1, 1, 1, 'Easy'),
(18, '¿Cuál de los siguientes no es un tipo de dato en PHP?', 'Void', 'String', 'Integer', 'Boolean', 1, 0, 1, 1, 'Easy'),
(19, '¿Qué significa API?', 'Application Programming Interface', 'Automated Program Interaction', 'Advanced Program Instructions', 'Application Performance Index', 4, 0, 1, 1, 'Easy'),
(20, '¿Cuál de los siguientes es un lenguaje de programación interpretado?', 'Python', 'C++', 'Java', 'C#', 2, 0, 1, 1, 'Easy'),
(21, '¿En qué año se produjo la Revolución de Mayo en Argentina?', '1810', '1820', '1830', '1840', 4, 0, 2, 1, 'Easy'),
(22, '¿Quién fue el primer presidente de Argentina?', 'Bernardino Rivadavia', 'Juan Manuel de Rosas', 'Bartolomé Mitre', 'Justo José de Urquiza', 3, 0, 2, 1, 'Easy'),
(23, '¿Qué batalla marcó el fin del dominio español en Argentina?', 'Batalla de Tucumán', 'Batalla de Cepeda', 'Batalla de Chacabuco', 'Batalla de Caseros', 0, 2, 2, 1, 'Easy'),
(24, '¿En qué año se sancionó la Constitución Nacional de Argentina?', '1853', '1863', '1873', '1883', 0, 2, 2, 1, 'Easy'),
(25, '¿Quién fue el prócer argentino conocido como \"El Padre de la Patria\"?', 'Manuel Belgrano', 'José de San Martín', 'Juan Manuel de Rosas', 'Domingo Faustino Sarmiento', 0, 1, 2, 1, 'Easy'),
(26, '¿En qué año se produjo la guerra de Malvinas entre Argentina y el Reino Unido?', '1982', '1972', '1992', '1962', 2, 1, 2, 1, 'Easy'),
(27, '¿Quién fue el general argentino que lideró la Campaña del Desierto?', 'Julio Argentino Roca', 'Bartolomé Mitre', 'Domingo Faustino Sarmiento', 'Juan Manuel de Rosas', 3, 0, 2, 1, 'Easy'),
(28, '¿En qué año se independizó Argentina?', '1816', '1826', '1836', '1846', 1, 2, 2, 1, 'Easy'),
(29, '¿Quién fue el presidente argentino que gobernó durante la conocida \"Década Infame\"?', 'Agustín P. Justo', 'Arturo Frondizi', 'Hipólito Yrigoyen', 'Roberto M. Ortiz', 0, 1, 2, 1, 'Easy'),
(30, '¿Qué presidente argentino fue derrocado por el golpe militar de 1976?', 'Isabel Perón', 'Juan Domingo Perón', 'Raúl Alfonsín', 'Néstor Kirchner', 2, 0, 2, 1, 'Easy'),
(31, '¿Cuál es el país más grande del mundo en términos de superficie?', 'Rusia', 'Canadá', 'China', 'Estados Unidos', 1, 1, 3, 1, 'Easy'),
(32, '¿Cuál es el río más largo del mundo?', 'El río Amazonas', 'El río Nilo', 'El río Misisipi', 'El río Yangtsé', 0, 4, 3, 1, 'Easy'),
(33, '¿Cuál es la montaña más alta del mundo?', 'El Monte Everest', 'El Monte Kilimanjaro', 'El Monte Aconcagua', 'El Monte McKinley', 3, 0, 3, 1, 'Easy'),
(34, '¿Cuál es la capital de Australia?', 'Canberra', 'Sídney', 'Melbourne', 'Brisbane', 0, 2, 3, 1, 'Easy'),
(35, '¿Cuál es el océano más grande del mundo?', 'El Océano Pacífico', 'El Océano Atlántico', 'El Océano Índico', 'El Océano Ártico', 1, 1, 3, 1, 'Easy'),
(36, '¿En qué continente se encuentra el desierto del Sahara?', 'África', 'Asia', 'América', 'Europa', 1, 1, 3, 1, 'Easy'),
(37, '¿Cuál es el país más poblado del mundo?', 'China', 'India', 'Estados Unidos', 'Brasil', 0, 4, 3, 1, 'Easy'),
(38, '¿Cuál es el país más pequeño del mundo en términos de superficie?', 'El Vaticano', 'Mónaco', 'Nauru', 'San Marino', 2, 0, 3, 1, 'Easy'),
(39, '¿En qué país se encuentra la Gran Muralla China?', 'China', 'India', 'Japón', 'Corea del Sur', 6, 0, 3, 1, 'Easy'),
(40, '¿Cuál es la isla más grande del mundo?', 'Groenlandia', 'Madagascar', 'Borneo', 'Nueva Guinea', 3, 1, 3, 1, 'Easy');
...
(41, 3, 0, 'incomplete', '2023-07-11 00:55:35', 0);
...
INSERT INTO `UserQuestions` (`UserQuestionID`, `UserID`, `QuestionID`, `GameID`) VALUES
(1, 3, 2, NULL),
(2, 3, 4, 2),
(3, 3, 19, 2),
(4, 3, 13, 2),
...
--
ALTER TABLE `UserQuestions`
  MODIFY `UserQuestionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=187;
