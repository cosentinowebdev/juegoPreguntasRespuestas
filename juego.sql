...
--
-- Servidor: localhost
-- Tiempo de generación: 03-07-2023 a las 22:16:25
...
(2, '¿Cuál de los siguientes no es un lenguaje de programación?', 'HTML', 'Java', 'Python', 'C++', 3, 0, 1, 1),
(3, '¿Qué significa CSS?', 'Cascading Style Sheets', 'Common Style Sheets', 'Creative Style Sheets', 'Computer Style Sheets', 0, 0, 1, 1),
(4, '¿Cuál es el símbolo utilizado para denotar una clase en CSS?', '.', '#', '@', '$', 1, 0, 1, 1),
...
(7, '¿Qué es un bucle \"for\" en programación?', 'Una estructura de control', 'Un tipo de dato', 'Una función', 'Un operador', 2, 0, 1, 1),
...
(11, '¿Cuál es el resultado de 5 modulo 2?', '1', '2', '0', '5', 0, 2, 1, 1),
(12, '¿Cuál de los siguientes no es un framework de desarrollo web?', 'Photoshop', 'React', 'Angular', 'Vue', 2, 0, 1, 1),
(13, '¿Cuál de los siguientes no es un tipo de dato primitivo en Java?', 'String', 'int', 'boolean', 'double', 0, 1, 1, 1),
(14, '¿Qué significa SQL?', 'Structured Query Language', 'Simple Query Language', 'System Query Language', 'Structured Query Logic', 0, 1, 1, 1),
(15, '¿Cuál es el resultado de la operación 4 + \"4\" en JavaScript?', '\"44\"', '8', 'NaN', '\"8\"', 0, 1, 1, 1),
...
(19, '¿Qué significa API?', 'Application Programming Interface', 'Automated Program Interaction', 'Advanced Program Instructions', 'Application Performance Index', 1, 0, 1, 1),
(20, '¿Cuál de los siguientes es un lenguaje de programación interpretado?', 'Python', 'C++', 'Java', 'C#', 0, 0, 1, 1),
(21, '¿En qué año se produjo la Revolución de Mayo en Argentina?', '1810', '1820', '1830', '1840', 2, 0, 2, 1),
(22, '¿Quién fue el primer presidente de Argentina?', 'Bernardino Rivadavia', 'Juan Manuel de Rosas', 'Bartolomé Mitre', 'Justo José de Urquiza', 1, 0, 2, 1),
(23, '¿Qué batalla marcó el fin del dominio español en Argentina?', 'Batalla de Tucumán', 'Batalla de Cepeda', 'Batalla de Chacabuco', 'Batalla de Caseros', 0, 2, 2, 1),
...
(32, '¿Cuál es el río más largo del mundo?', 'El río Amazonas', 'El río Nilo', 'El río Misisipi', 'El río Yangtsé', 0, 1, 3, 1),
...
(34, '¿Cuál es la capital de Australia?', 'Canberra', 'Sídney', 'Melbourne', 'Brisbane', 0, 1, 3, 1),
(35, '¿Cuál es el océano más grande del mundo?', 'El Océano Pacífico', 'El Océano Atlántico', 'El Océano Índico', 'El Océano Ártico', 1, 0, 3, 1),
...
(40, '¿Cuál es la isla más grande del mundo?', 'Groenlandia', 'Madagascar', 'Borneo', 'Nueva Guinea', 0, 1, 3, 1),
(41, 'algo', 'algo', 'algo', 'algo', 'algo', NULL, NULL, 1, 3),
(42, 'algo', 'algo', 'algo', 'algo', 'algo', NULL, NULL, 1, 3),
(43, 'algo', 'algo', 'algo', 'algo', 'algo', NULL, NULL, 1, 3),
(44, 'algo', 'algo', 'algo', 'algo', 'algo', NULL, NULL, 1, 3);
...
(10, 3, 0, 'incomplete', '2023-07-04 00:18:00', 0);
...
--
ALTER TABLE `UserQuestions`
  MODIFY `UserQuestionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
